...
int romanos_para_decimal(std::string s) {
    ...
    for(int i = 0; i < tamanho; i++) {
        ...
        // Converte o caractere romano atual para o seu valor em algarismos arábicos
        switch(s[i]) {
            ...
            default: return -1; // retorna -1 se houver um caractere inválido na string
        }

        // Verifica se o próximo caractere existe e o seu valor em algarismos arábicos
        if(i+1 < tamanho) {
            switch(s[i+1]) {
        ...
        // Se o valor do caractere atual for menor ou igual ao valor do próximo caractere,
        // adiciona o valor do caractere atual no resultado. Caso contrário, subtrai o valor
        // do próximo caractere do valor do caractere atual e adiciona a diferença no resultado.
